...
export function MessageList({
    ...
    return (
        <div className="flex-1 content-end overflow-y-auto py-4 md:py-6 px-4 md:px-7 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:bg-indigo-200 [&::-webkit-scrollbar-thumb]:rounded">
